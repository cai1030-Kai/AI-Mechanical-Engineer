...
calculations. Version 0.1 provides direct Python APIs and a command-line
...
- Two mechanics-of-materials stress calculators
...
The current v0.1 milestone has **97 passing tests** covering engineering
...
Planned calculators for the next milestones:

- Beam bending stress
- Euler buckling
- Factor of safety

See [v0.1.0 release notes](docs/releases/v0.1.0.md) for the milestone summary and
known limitations.
